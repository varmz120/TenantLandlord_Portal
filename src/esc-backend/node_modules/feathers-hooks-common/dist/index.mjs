...
function combine(...serviceHooks) {
  const isContext = function(ctx) {
    return typeof (ctx == null ? void 0 : ctx.method) === "string" && typeof (ctx == null ? void 0 : ctx.type) === "string";
  };
...
function cache(cacheMap, keyField, options) {
  const clone2 = (options == null ? void 0 : options.clone) || clone;
  const makeCacheKey = (options == null ? void 0 : options.makeCacheKey) || defaultMakeCacheKey;
  return (context) => {
    var _a;
    keyField = keyField || ((_a = context.service) == null ? void 0 : _a.id);
    let items = getItems(context);
...
function disallow(...transports) {
  return (context) => {
    var _a;
    const hookProvider = (_a = context.params) == null ? void 0 : _a.provider;
...
function paramsFromClient(...whitelist) {
  return (context) => {
    var _a;
    const params = context.params;
    if (((_a = params == null ? void 0 : params.query) == null ? void 0 : _a.$client) && typeof params.query.$client === "object") {
