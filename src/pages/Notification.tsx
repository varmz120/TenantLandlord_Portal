        ...
        <React.Fragment>
          ...
          {user?.userType === 0 ? (
            <div className="flex justify-center items-center">
              <div
                className="container mx-auto mt-10 mb-10 h-156 w-656">
                <div className="bg-white h-full overflow-y-auto rounded-lg drop-shadow-2xl">
                  <table className="table-auto w-full">
                    <thead>
                      <tr>
                        <th className="px-4 py-2 bg-tableHeader text-2xl text-left">Notification</th>
                      </tr>
                    </thead>
                      <tbody className="">
                        {tableData
                          .map((row) => (
                            ...
                            >
                              <td className="pb-10 pt-5 py-2 px-5 text-left">
                                <div className="flex">
                                  <span className={`mt-5 w-2 h-2 rounded-full justify-center ${row.Seen ? 'bg-transparent' : 'bg-activeField'}`}></span>
