...
const ReturnToHomePage: FC<InputProps> = ({ link, message_type }) => {
  if (message_type === 1) {
    return (
        ...
        <span className="inline-flex justify-left">
          <label className="ml-2 text-sm font-medium text-headerText">
            ...
            <a href={link} className="text-blue-600 dark:text-blue-500 hover:underline">
              {' '}
              {/* Add routing to either login page or dashboard depending on login status */}
