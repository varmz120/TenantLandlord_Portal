...
const DropdownField: FC<InputProps> = ({
  ...
  return (
    <div className={"flex text-left " +  (layout == 'vertical' ? 'flex-col' : '')} >
      ...
      <select disabled={disabled} name={name} onChange={onChange} value={value} className={"mt-2 w-2/5 bg-inputField text-placeholderText focus:outline-none focus:border-sky-599 focus:ring-1 focus:bg-userNameButton focus:ring-sky-500 font-light rounded py-1 px-2 text-left inline-flex items-center " + classnames}>
