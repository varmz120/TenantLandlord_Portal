          ...
          <ul className="h-full font-base text-sm flex flex-col p-4 md:p-0 mt-4 border rounded-lg md:flex-row md:mt-0 md:border-0">
            ...
            <li className="flex items-center mx-3 mr-5">
              ...
              >
                <div
                  className={
                    "w-8 h-5 mx-3 ml-3 bg-contain bg-center bg-no-repeat bg-[url('./images/log_out_icon.svg')] group-hover:bg-[url('./images/user_icon_dark.svg')]"
                  }
                ></div>
                <div className="mr-4">Log Out</div>
              </a>
            </li>
          </ul>
        </div>
